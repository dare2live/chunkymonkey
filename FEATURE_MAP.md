...
> Codegraph: 节点 7,906 | calls 边 101,785 | imports 边 13,749 (每次 codegraph sync 波动, 不参与漂移判定)
...
| backend/services/duck_adapter.py | 14 |
...
| backend/scripts/experiment_l0_baseline.py | 8 |
