...
统计: 表 34 张 | 单 writer 22 | 多 writer 12 | 动态表名写点 63 处 (21 文件)
...
> Codegraph: 节点 8,330 | calls 边 9,811 | imports 边 2,909 (每次 codegraph sync 波动, 不参与漂移判定)

### 被 import 最多的模块 (top 15)

| 模块 | import 处数 |
|---|---|
| services.duck_adapter | 57 |
