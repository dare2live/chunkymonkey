...
> Codegraph: 节点 8,104 | calls 边 9,385 | imports 边 2,875 (每次 codegraph sync 波动, 不参与漂移判定)
...
| 文件 | 行数 |
|---|---|
| backend/services/data_sources/sync_runner.py | 3467 |
