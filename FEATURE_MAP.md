...
统计: 表 34 张 | 单 writer 22 | 多 writer 12 | 动态表名写点 59 处 (20 文件)
...
> Codegraph: 节点 8,274 | calls 边 9,736 | imports 边 2,900 (每次 codegraph sync 波动, 不参与漂移判定)

### 被 import 最多的模块 (top 15)

| 模块 | import 处数 |
|---|---|
| services.duck_adapter | 55 |
...
| 文件 | 行数 |
|---|---|
| backend/services/data_sources/sync_runner.py | 3931 |
| backend/services/market_pulse.py | 1528 |
