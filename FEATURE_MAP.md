...
> Codegraph: 节点 9,768 | calls 边 11,558 | imports 边 3,230 (每次 codegraph sync 波动, 不参与漂移判定)
...
| backend/scripts/check_continuity_integrity.py | 1047 |
