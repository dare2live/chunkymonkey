...
统计: 表 302 张 | 单 writer 181 | 多 writer 121 | 动态表名写点 76 处 (39 文件)
...
> Codegraph: 节点 19,547 | calls 边 208,443 | imports 边 20,447 (每次 codegraph sync 波动, 不参与漂移判定)
