...
> Codegraph: 节点 8,173 | calls 边 9,512 | imports 边 2,890 (每次 codegraph sync 波动, 不参与漂移判定)
...
| 文件 | 行数 |
|---|---|
| backend/services/data_sources/sync_runner.py | 3929 |
