...
> Codegraph: 节点 9,225 | calls 边 101,244 | imports 边 14,005 (每次 codegraph sync 波动, 不参与漂移判定)
...
| 文件 | 调用方文件数 |
|---|---|
| backend/services/database_manifest.py | 26 |
...
| backend/scripts/experiment_yushen_clean_baseline.py | 5 |
