...
> Codegraph: 节点 9,868 | calls 边 11,691 | imports 边 3,266 (每次 codegraph sync 波动, 不参与漂移判定)
...
| backend/scripts/check_continuity_integrity.py | 1109 |
