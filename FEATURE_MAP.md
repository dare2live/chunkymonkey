...
统计: 表 46 张 | 单 writer 34 | 多 writer 12 | 动态表名写点 16 处 (9 文件)
...
> Codegraph: 节点 4,486 | calls 边 6,473 | imports 边 1,255 (每次 codegraph sync 波动, 不参与漂移判定)
