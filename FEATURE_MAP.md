...
> Codegraph: 节点 9,530 | calls 边 11,299 | imports 边 3,165 (每次 codegraph sync 波动, 不参与漂移判定)
...
| 文件 | 行数 |
|---|---|
| backend/services/data_sources/sync_runner.py | 4082 |
