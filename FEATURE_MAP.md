...
> Codegraph: 节点 7,788 | calls 边 101,669 | imports 边 13,708 (每次 codegraph sync 波动, 不参与漂移判定)
...
| services.portfolio_walk_forward.oos_ic | 8 |
| services.pricing_policy | 8 |
| services.experiment_harness | 7 |
| routers.updater_runtime | 6 |
| scripts.experiment_l0_baseline | 6 |
...
| backend/services/duck_adapter.py | 11 |
...
| backend/services/experiment_store.py | 4 |
