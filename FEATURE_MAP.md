...
> Codegraph: 节点 6,229 | calls 边 7,371 | imports 边 1,941 (每次 codegraph sync 波动, 不参与漂移判定)
...
| 文件 | 行数 |
|---|---|
| backend/services/data_sources/sync_runner.py | 2751 |
