...
> Codegraph: 节点 7,446 | calls 边 8,697 | imports 边 2,522 (每次 codegraph sync 波动, 不参与漂移判定)

### 被 import 最多的模块 (top 15)

| 模块 | import 处数 |
|---|---|
| services.duck_adapter | 49 |
...
| services.tier12_publish_writer | 11 |
...
| backend/services/institution_follow_b0.py | 9 |
| backend/services/tier12_publish_writer.py | 8 |
...
| 文件 | 行数 |
|---|---|
| backend/services/data_sources/sync_runner.py | 2920 |
...
| backend/services/research_runtime.py | 749 |
| backend/routers/market_pulse.py | 742 |
