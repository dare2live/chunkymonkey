...
统计: 表 161 张 | 单 writer 92 | 多 writer 69 | 动态表名写点 31 处 (18 文件)
...
> Codegraph: 节点 8,986 | calls 边 98,082 | imports 边 13,304 (每次 codegraph sync 波动, 不参与漂移判定)
