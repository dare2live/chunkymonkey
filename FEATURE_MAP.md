...
> Codegraph: 节点 7,940 | calls 边 9,300 | imports 边 2,841 (每次 codegraph sync 波动, 不参与漂移判定)
...
| 文件 | 行数 |
|---|---|
| backend/services/data_sources/sync_runner.py | 3413 |
