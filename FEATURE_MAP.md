...
> Codegraph: 节点 9,151 | calls 边 101,185 | imports 边 13,932 (每次 codegraph sync 波动, 不参与漂移判定)
...
| 文件 | 调用方文件数 |
|---|---|
| backend/services/database_manifest.py | 22 |
| backend/services/duck_adapter.py | 16 |
| backend/services/experiment_store.py | 15 |
