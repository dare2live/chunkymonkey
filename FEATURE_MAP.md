...
> Codegraph: 节点 8,008 | calls 边 101,938 | imports 边 13,717 (每次 codegraph sync 波动, 不参与漂移判定)
...
| 文件 | 调用方文件数 |
|---|---|
| backend/services/database_manifest.py | 16 |
| backend/services/duck_adapter.py | 12 |
| backend/services/experiment_store.py | 9 |
