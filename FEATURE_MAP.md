...
> Codegraph: 节点 4,893 | calls 边 5,913 | imports 边 1,166 (每次 codegraph sync 波动, 不参与漂移判定)

### 被 import 最多的模块 (top 15)

| 模块 | import 处数 |
|---|---|
| services.duck_adapter | 35 |
| services.data_sources | 28 |
| services.data_sources.margin_schema | 14 |
| services.source_watermarks | 13 |
| services.database_manifest | 12 |
| services.data_sources.contracts | 9 |
| services.data_sources.margin_acceptance | 9 |
| services.data_sources.margin_validation | 8 |
| services.db | 8 |
| services.data_sources.batch_integrity | 7 |
| services.data_sources.margin_evidence | 7 |
| services.data_sources.margin_legacy_reconcile | 7 |
| services.data_sources.margin_state | 7 |
| services.data_sources.margin_reconcile | 6 |
...
| backend/services/data_sources/margin_acceptance.py | 9 |
| backend/services/data_sources/margin_evidence.py | 7 |
| backend/services/data_sources/margin_state.py | 7 |
| backend/services/pipeline/context.py | 7 |
| backend/services/data_sources/margin_reconcile.py | 6 |
...
| 文件 | 行数 |
|---|---|
| backend/services/data_sources/sync_runner.py | 2462 |
...
| backend/services/data_sources/margin_acceptance.py | 689 |
| backend/services/data_sources/margin_history.py | 640 |
| backend/routers/market_pulse.py | 624 |
| backend/services/data_sources/margin_legacy_reconcile.py | 605 |
| backend/services/data_sources/margin_ingest.py | 604 |
