...
统计: 表 161 张 | 单 writer 92 | 多 writer 69 | 动态表名写点 37 处 (21 文件)
...
> Codegraph: 节点 9,424 | calls 边 91,881 | imports 边 11,918 (每次 codegraph sync 波动, 不参与漂移判定)
...
| backend/services/industry.py | 5 |
