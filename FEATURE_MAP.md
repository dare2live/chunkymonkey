...
> Codegraph: 节点 9,118 | calls 边 101,152 | imports 边 13,903 (每次 codegraph sync 波动, 不参与漂移判定)
...
| services.database_manifest | 21 |
| services.industry | 15 |
| services.tdx_source | 15 |
| services.experiment_store | 12 |
...
| 文件 | 调用方文件数 |
|---|---|
| backend/services/database_manifest.py | 20 |
| backend/services/duck_adapter.py | 16 |
| backend/services/experiment_store.py | 13 |
