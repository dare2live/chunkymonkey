...
统计: 表 302 张 | 单 writer 181 | 多 writer 121 | 动态表名写点 72 处 (37 文件)
...
> Codegraph: 节点 19,096 | calls 边 207,476 | imports 边 20,306 (每次 codegraph sync 波动, 不参与漂移判定)
