...
> Codegraph: 节点 9,135 | calls 边 101,167 | imports 边 13,917 (每次 codegraph sync 波动, 不参与漂移判定)
...
| services.database_manifest | 22 |
| services.industry | 15 |
| services.tdx_source | 15 |
| services.experiment_store | 13 |
...
| 文件 | 调用方文件数 |
|---|---|
| backend/services/database_manifest.py | 21 |
| backend/services/duck_adapter.py | 16 |
| backend/services/experiment_store.py | 14 |
