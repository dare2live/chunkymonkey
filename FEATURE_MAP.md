...
> Codegraph: 节点 9,048 | calls 边 10,586 | imports 边 3,037 (每次 codegraph sync 波动, 不参与漂移判定)
...
| 文件 | 行数 |
|---|---|
| backend/services/data_sources/sync_runner.py | 4016 |
