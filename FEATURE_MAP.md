...
统计: 表 164 张 | 单 writer 93 | 多 writer 71 | 动态表名写点 20 处 (12 文件)
...
> Codegraph: 节点 7,960 | calls 边 101,775 | imports 边 13,759 (每次 codegraph sync 波动, 不参与漂移判定)
...
| scripts.experiment_l0_baseline | 13 |
| services.experiment_harness | 12 |
| services.kline_source | 11 |
| services.formula_engine.features | 9 |
