...
统计: 表 161 张 | 单 writer 92 | 多 writer 69 | 动态表名写点 25 处 (15 文件)
...
> Codegraph: 节点 8,901 | calls 边 98,015 | imports 边 13,248 (每次 codegraph sync 波动, 不参与漂移判定)
...
| 文件 | 调用方文件数 |
|---|---|
| backend/services/duck_adapter.py | 18 |
