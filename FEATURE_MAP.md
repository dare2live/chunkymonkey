...
> Codegraph: 节点 8,218 | calls 边 9,655 | imports 边 2,894 (每次 codegraph sync 波动, 不参与漂移判定)

### 被 import 最多的模块 (top 15)

| 模块 | import 处数 |
|---|---|
| services.duck_adapter | 53 |
...
| backend/services/market_pulse.py | 1516 |
