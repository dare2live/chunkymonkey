...
| 数据完整性实跑 | **FAIL: K 线 OK / 下游 8 issues** | 2026-06-01 已用 tdxhub 增量把 `price_kline_tdxhub` 补到交易日历 `2026-05-29`，最新审计为 `max=2026-05-29 / n_codes=5,188 / = cal / OK`；最近覆盖: 2026-05-26=5201、05-27=5184、05-28=5184、05-29=5188，仍有 16 个历史/停牌/异常 code latest < 2026-05-29。剩余 stale: `fact_alpha158_panel` 2026-05-25，`mart_p0a_label_panel`/`mart_p0a_feature_label_panel_v3/v4`/`mart_sniper_score_daily`/`mart_institution_score_daily` 2026-05-19，`fact_technical_trigger` 2026-05-19，`fact_lhb_event` 2026-05-25。`fact_capital_flow_pit_daily`、`fact_risk_factors`、`fact_sector_momentum_daily` 仍停 2026-05-26，需随下游链路评估。 |
