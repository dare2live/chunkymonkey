...
> 3. 通达信 6/7 xdxr/server (须先收口 main 上 4 个红 K线测试 — price_kline_qfq_tushare 缺, 与 price_kline_tdxhub_adjustment_event 物删纠缠) / akshare M4 / 通达信客户端 dead 代码整段物删 = 完成度收尾。
