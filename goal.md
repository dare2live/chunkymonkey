...
| stage-opt 2026-06-02 05:57-05:58 dynamic_ma 0-iteration lift | **PASS scoped / upstream supply evidence**: 2026-06-02 05:57-05:58 将 `dynamic_ma_iterative_cross` 默认迭代轮数从 1 轮压到 0 轮，历史重算后该 formula 的 `rows / keys / ready coverage` 提升到 `144,282 / 20,522 / 56.83%`；全局审计刷新为 `raw_signal_rows=5,520,983 / filtered_signal_rows=2,758,502 / unique_keys=151,827 / ready_keys=110,102 / ready coverage=72.52% / below_min_signals=41,725`，`min_signals=4/3/2` 现在对应 `78.24% / 84.41% / 91.30%`（`118,793 / 128,150 / 138,611` ready keys）；controller recommendation 仍然是 `P1 / upstream_candidate_supply`，说明这刀继续抬升了 supply，但结构性瓶颈仍然在上游候选供给。 |
