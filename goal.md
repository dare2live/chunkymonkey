...
- Phase 5 retrain start_date=2022 walk-forward 扩 OOS ≥ 60 obs (GCP VM ~35-50h batch, ~1 week)
- PBO multi-trial 5/10/20d retrain (#3 85→100%, ~3 days)
- Phase 4 holdout 跨 5 年 KPI 全验 (#6 5→80%+, 2-3 weeks)
