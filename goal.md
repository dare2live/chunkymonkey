...
| 端到端审计实跑 | **PASS with WARN: 24 total / 18 OK / 6 WARN / 0 FAIL** | 2026-06-01 04:20 CST 复跑已无 FAIL：`mart_stock_picture_daily` 与 `mart_stock_survey_features` 均补到 2026-05-29；仍有 6 WARN，包括最新推荐 PIT coverage=0、`fact_signal_context`/`fact_technical_trigger`/picture/survey freshness days_behind=3、推荐行数偏少。不能当生产证据。 |
