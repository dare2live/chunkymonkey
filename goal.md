...
| 数据完整性实跑 | **FAIL: K线/alpha158/stage/context/trigger OK-ish / picture+survey caught up / 下游 7 issues** | 2026-06-01 已把 `price_kline_tdxhub`、`fact_alpha158_panel`、`fact_stock_technical_stage`、`fact_signal_context`、`fact_technical_trigger`、`mart_stock_picture_daily`、`mart_stock_survey_features` 补到交易日历 `2026-05-29`；survey 05-21..05-29 窗口 25,897 rows，picture 05-27..05-29 每日 5,203 rows。最新 completeness 仍 FAIL: label/v3/v4/sniper/institution 停 2026-05-19，`fact_lhb_event` 停 2026-05-25，trigger 仅事件型覆盖 1,692 codes 被记 `PARTIAL_WARN`。`fact_capital_flow_pit_daily`、`fact_risk_factors`、`fact_sector_momentum_daily` 仍停 2026-05-26，需随下游链路评估。 |
