...
| 2 | 策略模型管理 | MSAF 3 类策略 (纯量化/狙击/机构跟随) + ensemble + regime gate 全上线 + paper_sim KPI 达标 | **80%** (Phase 1 全 / Phase 2 全 (3 类 alpha) / Phase 3.1 regime 8/8 / Phase 3.2 ensemble 8/8 / Phase 3.3 ensemble paper_sim runner + KPI compute: **median ann +34.88% 在 25-35% 目标上限** (n=22 monthly obs 实测 a704770a), max_dd -21.38%, sharpe 1.347, hit 63.64%. 待 Phase 3.4 接 sniper/institution 真 source + Phase 4 holdout 扩 OOS ≥ 30 obs) |
