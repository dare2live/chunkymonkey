...
def main() -> int:
    ...
    p.add_argument("--policy-run-id", default=DEFAULT_BESTCHOICE_PIPELINE_CONFIG.context_exit_policy_run_id_full)
    p.add_argument("--bc-run-id", default=DEFAULT_BESTCHOICE_PIPELINE_CONFIG.bc_run_id)
    args = p.parse_args()
