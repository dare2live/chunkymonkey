...
def init_db():
    ...
    try:
        conn.executescript("""
            ...
            CREATE TABLE IF NOT EXISTS fact_feature_panel_tdx_keep_challenger (
                feature_set_id TEXT NOT NULL,
                stock_code TEXT NOT NULL,
                date TEXT NOT NULL,
                regime_flag TEXT,
                ...
                momentum_diff REAL,
                amount_chg_5d REAL,
                inst_event_count_30d REAL,
                inst_event_count_60d REAL,
                exec_buy_count_90d REAL,
                exec_buy_ge1_count_90d REAL,
                lhb_inst_buy_count_30d REAL,
                lhb_inst_buy_count_60d REAL,
                jgdy_count_60d REAL,
                dzjy_count_60d REAL,
                days_since_exec_buy REAL,
                days_since_lhb REAL,
                shareholder_count_qoq REAL,
                inst_count_qoq REAL,
                fund_count_qoq REAL,
                qfii_count_qoq REAL,
                yjyg_lower_pct REAL,
                ...
                ret_60d_rank REAL,
                vol_z20d_rank REAL,
                amount_chg_5d_rank REAL,
                rz_balance_rank REAL,
                rz_chg_5d_pct_rank REAL,
                ret_20d_tdx_l1_rel REAL,
                ret_60d_tdx_l1_rel REAL,
                vol_z20d_tdx_l1_rel REAL,
                amount_chg_5d_tdx_l1_rel REAL,
            ...
            CREATE INDEX IF NOT EXISTS idx_tdx_keep_panel_date
                ON fact_feature_panel_tdx_keep_challenger(feature_set_id, date);
