...
设计原则：
- Identity / names: dim_active_a_stock (reference). Holders SSOT =
  canonical_top10_float_holders_period (fact_top10 DROPPED 2026-07-26).
  Historical fact rows only represented "曾经出现过的代码" — not identity truth.
