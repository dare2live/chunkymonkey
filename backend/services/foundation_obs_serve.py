...
_GROUPS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("行情与量价", ("daily", "kline_daily", "daily_basic", "adj_factor", "cyq_perf", "block_trade")),
    ("资金与情绪", (
        "moneyflow", "moneyflow_dc", "moneyflow_mkt_dc", "moneyflow_hsgt", "moneyflow_ind_dc",
        "margin", "margin_detail", "limit_list_d", "limit_cpt_list",
        "top_list", "top_inst",
    )),
    ("指数与分类", (
        "index_daily", "index_daily_benchmark", "index_dailybasic", "sw_daily",
        "dc_index", "dc_member", "index_member_all", "index_member_all_hist",
        "industry_dc",
    )),
    ("财报与披露", (
