...
DATA_ROUTES = [
    ...
    {
        "data_name": "财务派生 (tushare 周期模型)",
        "raw_table": "raw_tushare_fina_indicator / balancesheet / income",
        "current": {"source": "tushare", "protocol": "registry sync", "status": "connected"},
        "target": None,
        "freshness": "季",
        "step_id": "sync_financial",
        "client_module": "services/financial_client.py (calc_financial_derived)",
        "notes": "2026-06-27 通达信全删: gpcw 退役物删, 财务派生迁 tushare; dim_financial_latest=每股最新期快照",
    },
    {
        "data_name": "除权除息",
        "raw_table": "raw_xdxr",
