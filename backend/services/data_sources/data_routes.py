...
DATA_ROUTES = [
    ...
    # =================================================================
    {
        ...
        "target": {"source": "aif10", "protocol": "RPT_BILLBOARD_DAILYDETAILS + RPT_OPERATEDEPT_TRADE", "phase": "P6.2"},
        "freshness": "T-0",
        "step_id": "sync_lhb",
        "client_module": "services/lhb_client.py",
        "notes": "妙想已实测 OK (468 行/全市场); 字段不同需要重写 _map 函数, 工程量 ~1 小时",
    },
    {
        "data_name": "QFII 持仓 (季)",
        "raw_table": "raw_qfii_holding_quarterly",
        "current": {"source": "datacenter_web", "protocol": "datacenter-web RPT_DMSK_HOLDERS (个股+机构维度)", "status": "transitional"},
        "target": {"source": "aif10", "protocol": "RPT_MAIN_ORGHOLDDETAIL (个股+机构) - 不是 RPT_F10_MAIN_ORGHOLDDETAILS (汇总)", "phase": "P6.4"},
        "freshness": "季",
        "step_id": "sync_qfii",
        "client_module": "services/qfii_client.py",
        "notes": "P6.4: RPT_F10_MAIN_ORGHOLDDETAILS 是汇总维度, 跟项目要的个股×机构不同. 需换 RPT_MAIN_ORGHOLDDETAIL, 工程量 ~1.5 小时",
    },
    {
        "data_name": "融资融券",
        "raw_table": "raw_margin_daily",
        "current": {"source": "datacenter_web", "protocol": "datacenter-web RPT_MARGIN_*", "status": "transitional"},
        "target": {"source": "aif10", "protocol": "RPT_MARGIN_STATISTICS_STOCKS + RPT_STOCK_MARGINTRENDEXPLAIN", "phase": "P6.3"},
        "freshness": "T-0",
        "step_id": "sync_margin",
        "client_module": "services/margin_client.py",
        "notes": "P6.3: 全市场 TRADE_DATE filter 当前 0 行 (4-28), 需验证 filter 语法 + 重写 schema, 工程量 ~1 小时",
    },
    {
        "data_name": "机构调研事件",
