...
# _TDX_SERVER_HEALTH_DECAY_HALF_LIFE_HOURS/_MEMORY_ATTEMPTS 已删 2026-06-27 (server_health DB 退役)
...
# [RETIRED 2026-06-27 通达信全删 单元7] TDX_SERVER_HEALTH_DDL 删 (mart_tdx_server_health 表已物删)
...
# [RETIRED 2026-06-27 通达信全删 单元7] server_health DB持久化函数整段物删 (mart_tdx_server_health 表已物删):
#   ensure/record_attempts/record_runtime/load + 内部 helper (_compute_health_score/_existing/_replace/_effective/_cap/_scaled/_age_decay/_parse_utc/_server_from_attempt/_utc_now_text/decay/memory)。
#   live in-memory circuit-breaker (call_tdx_quotes_with_retry/_mark_*/_should_cooldown/iter_tdx_servers) 保留在上方+下方, 不依赖本段。
