> **[状态校正 2026-07-02 批5]**: 迁移已完成且政策两处演进 — ①"双轨核对≥99%"仪式 2026-06-23 被用户推翻 (规则简化为"tushare有就用+删旧源"); ②"tushare 唯一"已开 aif10 正式例外 (2026-06-24, holder/机构持仓/估值)。现行政策唯一 owner = CLAUDE.md §4.3。本文留迁移方法论历史参考。
