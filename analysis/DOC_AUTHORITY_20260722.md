...
| `workbench_incremental_orchestrator_ux_20260722.md` | acquire UX P0.1–P3 活计划（delta/传感器/进度）；**P1 CX-1 PASS**（`cx1_…`）· **P3 CX-2 PASS**（`cx2_state_sensors_acceptance_20260722.md`） |
