...
- current_state: `architecture/data freshness repair / shared-config boundary cleanup / moth-canonical shared tooling state / workbench health widget extraction / ETF workbench widget extraction / stage-opt structural blocker triage`
