...
**定义**：S7 `legacy_raw_plane.yaml` + `check_legacy_raw_plane.py` 维护的 **46 域 inventory** 中，仍被分类为 **`role=ssot` 且 publication/serve 经 raw_tushare_*`** 的表 — 当前 **29/46**（1 fill，16 compatibility）。
