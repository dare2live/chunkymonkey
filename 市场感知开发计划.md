...
- UI 增加主题主线 / 支线 / 退潮视图。[pending]
- 至少 3 个历史主题 case study，人工 sanity check。[pending]
...
3. P3 下一步补 UI 主题主线 / 分歧 / 退潮视图，并做至少 3 个历史主题 case study；当前 MVP 只覆盖 observed PIT 行业快照区间，不回填 fallback 历史。
