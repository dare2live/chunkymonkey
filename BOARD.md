...
- B5 brick registry PARTIAL: L2/L3 manifest + orphan/hop/raw gate shipped; residual = qfq physical lineage columns (or honest UNTRUSTED read); Type-B registered (no fake FIXED)
