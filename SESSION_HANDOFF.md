...
- shared-config boundary note: common holding windows, stage thresholds, MACD
  ...
  thresholds and bins, and the backtest default stop/target/trailing now live
  in shared YAML configs
...
|---|---|
| Branch | main |
| HEAD | `ddcfae6d docs: refresh session handoff snapshot after stock-formula optuna bins cleanup | # commit-msg: minimal` |
| 最近 24h commits | 123 |
| 未 commit 文件 | 0 |
...
```
ddcfae6d docs: refresh session handoff snapshot after stock-formula optuna bins cleanup | # commit-msg: minimal
