...
| Live continuity | `PYTHONPATH=backend python backend/scripts/check_continuity_integrity.py` (`FAIL` 直接非零；daily/ST 读 `accepted_partition` formal frontier；**Knife4 FIXED** + §6 exit + **100% usable MET**（无 class-A；annotate=class-B）；根因 `analysis/foundation_residual_rootcause_20260723.md`） |
