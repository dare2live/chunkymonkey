...
最后更新: **2026-06-04** (after-close data refresh + controller-agent preflight hard gate + retention dry-run inventory + DB manifest attach policy + DB boundary static gate + holder replay safety + Codex instruction-source boundary + DuckDB capacity audit + need_027 exact-flow probe gate + stage-opt supply contract).
