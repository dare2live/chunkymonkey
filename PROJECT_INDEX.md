...
| Live continuity | `PYTHONPATH=backend python backend/scripts/check_continuity_integrity.py` (`FAIL` 直接非零；daily/ST 读 `accepted_partition` formal frontier；**Knife4 2026-07-23**：accepted `coverage_start`≠表 MIN 不算 declared_drift；annotate 域 interior gaps 保留 WARN；证据 `analysis/continuity_knife4_20260723.md`) |
