...
- **stage-opt 2026-06-02 dynamic_ma 0-iteration lift**: `dynamic_ma_iterative_cross` 默认迭代轮数从 1 轮压到 0 轮后，历史重算把该 formula 提升到 `144,282 / 20,522 / 56.83%`；全局审计刷新为 `5,520,983 raw_signal_rows / 2,758,502 filtered_signal_rows / 151,827 unique_keys / 110,102 ready_keys / 72.52% ready coverage / 41,725 below_min_signals`，`min_signals=4/3/2` 对应 `78.24% / 84.41% / 91.30%`（`118,793 / 128,150 / 138,611` ready keys）。这刀继续抬高 evidence density，但 controller 仍指向 `P1 / upstream_candidate_supply`，所以结构性瓶颈没变。
