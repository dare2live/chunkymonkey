...
- **2026-06-05 data-health SLA rollover**: 2026-06-05 08:39 CST 复跑 `doctor --fast` 后，freshness SLA 滚动使 data-health 当前变为 `green=321 / yellow=21 / red=0 / blocking_yellow=4`。blocking 表是 financial PIT、fundamental stage、feature drift 与 drift histogram；这是新的 live 维护状态，不是 design-review gate 代码回归。
