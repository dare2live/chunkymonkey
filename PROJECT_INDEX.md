...
| Live continuity | `PYTHONPATH=backend python backend/scripts/check_continuity_integrity.py` (`FAIL` 直接非零；daily/ST 读 `accepted_partition` formal frontier；**Knife4 FIXED** + **foundation §6 exit MET** 2026-07-23：annotate WARN 保留；验收 `analysis/foundation_exit_verification_20260723.md`；100% usable=PARTIAL) |
