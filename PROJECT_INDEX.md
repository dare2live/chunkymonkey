...
> 更新：2026-07-21
> 当前目标看 `goal.md`（S1–S6 FIXED；S7 PARTIAL stronger 36/46 ssot；§15 knife-merge adoption；E0 PARTIAL；C/B-pit cutover ON；`BOARD.md`；启动 `scripts/chunkyctl agent-boot`）。
...
（ST asymmetric `20220104`）；`legacy_raw_plane.yaml` + gate（**36/46 ssot**）；§15 `pre-knife`。
S6 serve（FIXED）：
